...
<img src="https://braillerap.readthedocs.io/en/latest/_images/ecrou.jpg" alt="Standard nuts" width="150">

**M3 nyloc nut** or **M5 nyloc nut** refer to **locking** nuts with a diameter of 3mm or 5mm

<img src="https://braillerap.readthedocs.io/en/latest/_images/ecrounyl.jpg" alt="Nyloc nuts" width="150">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/gluing_chassis.png" alt="Chassis gluing orientation" width="350">

2. Apply glue to the notches and assemble the 5 parts
3. Secure with painter's tape until the glue is fully dry

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.01.jpg" alt="Assembled wooden enclosure" width="350">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/chassis_disc.png" alt="Door stops installation" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/paper_support_parts.jpg" alt="Paper support parts" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/paper_support_v8.png" alt="Paper support assembly" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.56.jpg" alt="Braille stylus preparation" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/Axis_assembly_v1.png" alt="Axis supports" width="250">

2. Insert an M3 nut into each of the rectangular holes in all 3 parts, then thread in the M3-12 grub screws.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.09.1.jpg" alt="Inserting nuts and screws" width="250">

3. Ensure the tip of the screw does not protrude into the hole for the 8mm rods:

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.10.jpg" alt="Screw positioning check" width="250">

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.11.jpg" alt="Final axis support assembly" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.41.jpg" title="" alt="Tapping roll joints" width="203">

**Steps:**

1. Put the O-rings in the groove of the 3 or 4 ROLL_joint3:
   
   <img title="" src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.42.jpg" alt="_images/BrailleRAP-V5.42.jpg" width="188">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.43.jpg" alt="Installing grub screws" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.113.png" alt="Clipboard positioning" width="250">

2. Position the spring between **clipboard2** and **clipboard2_support**.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.113.1.png" alt="Spring positioning" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.113.2.png" alt="Spring assembly" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.113.3.png" alt="Wheel assembly" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/xmotor_support_assembly_v2_1.png" alt="X motor support nuts" width="250">

2. Join the two printed parts **XMOTOR_support3_1** and **XMOTOR_support3** with two M3-14 screws.

<img src="https://braillerap.readthedocs.io/en/latest/_images/xmotor_support_assembly_v1_2.png" alt="X motor support assembly" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/xmotor_support_assembly_v1_3.png" alt="X motor installation" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.03.jpg" alt="Y motor pulley attachment" width="250">

2. Tap both sides of the middle part of the support (**YMOTOR_support2_200_2**)

<img src="https://braillerap.readthedocs.io/en/latest/_images/ymotor_support_assembly_1.png" alt="Tapping Y motor support part 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/ymotor_support_assembly_2.png" alt="Tapping Y motor support part 2" width="250">

3. Attach the two printed parts **YMOTOR_support2_200_2** and **YMOTOR_support2_200_1** with M3-12 screws.

<img src="https://braillerap.readthedocs.io/en/latest/_images/ymotor_support_assembly3.png" alt="Y motor support parts assembly" width="250">

4. Attach the part **YMOTOR_support2_200** to the previous two with an M3-12 screw.

<img src="https://braillerap.readthedocs.io/en/latest/_images/ymotor_support_assembly_4.png" alt="Y motor support final assembly" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/ymotor_support_assembly_5.png" alt="Y motor mounting" width="250">

6. Insert the 4 M3 nyloc nuts into the motor mount. Hold them in place with a small piece of painter's tape.

<img src="https://braillerap.readthedocs.io/en/latest/_images/ymotor_support_assembly_6.png" alt="Y motor nyloc nuts" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.45.png" alt="X limit switch nut insertion" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.45-1.png" alt="X limit switch screw installation" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/endtsopx_assembly.png" alt="X limit switch assembly" width="250">

**Note:** It's better to use a straight aligned wired endswitch.

<img src="https://braillerap.readthedocs.io/en/latest/_images/endstop_droit.jpg" alt="Straight endstop preferred" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.16.png" alt="Solenoid spacer installation" width="250">

2. Install the M3-16 screw with the shaped Braille stylus tip, allowing it to extend approximately 6mm beyond the spacer.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.17.png" alt="Braille stylus installation" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.19.png" alt="Solenoid mounting" width="250">

**Note:** Be sure to carefully align the edge of the plastic part with the edge of the solenoid

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.19-1.png" alt="Solenoid alignment" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/motorx_mount_1.jpg" alt="X motor mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/motorx_mount_2.jpg" alt="X motor mounting step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/ymotor_support_assembly_8.jpg" alt="Y motor mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/ymotor_support_assembly_7.jpg" alt="Y motor mounting step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.12.1.jpg" alt="Left axis supports mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.12.2.jpg" alt="Left axis supports mounting step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.12.3.jpg" alt="Right axis supports mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.12.4.jpg" alt="Right axis supports mounting step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.44.jpg" alt="Belt tensioner part" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.13.3.jpg" alt="Belt tensioner mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.13.5.jpg" alt="Belt tensioner mounting step 2" width="250">

2. Leave a gap of ~5mm.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.13.4.jpg" alt="Belt tensioner gap" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.13.6.jpg" alt="Free pulleys assembly" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/bottom_trolley_ok_v9.png" alt="Bottom carriage bearing placement" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/bottom_trolley_assembly_v1-1.png" alt="Bottom carriage assembly" width="250">

<img src="https://braillerap.readthedocs.io/en/latest/_images/bottom_trolley_assembly-v4.png" title="" alt="Bottom carriage clamp positioning" width="300">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.14-3.png" alt="Solenoid mounting on carriage" width="250">

3. Screw the two M3-20 screws (which will hold the strap) and 2 M3 nyloc nuts with the screw head underneath.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.14-4.png" alt="Belt attachment screws" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.14-5.png" alt="Stylus adjustment" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.18.png" alt="Final stylus positioning" width="250">
...
1. Glue the thread of the cap nut and screw the M3-30 headless screw on the side **WITHOUT** hex hole
   ...
   <img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.79.jpg" alt="Top carriage blind nut preparation" width="250">

2. Place a lock nut on the blind nut.

3. Tap the FEMALE_shape 2/3 of the way from the top.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.80.jpg" alt="Tapping female shape" width="250">

4. Adjust the M3-30 screw / blind nut assembly so it extends approximately 0.5mm.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.81.jpg" alt="Screw adjustment" width="250">

5. Assemble the FEMALE_shape on the TOP_trolley with the M3-12 screws, the M3 washers and the M3 nyloc nuts.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.82.png" alt="Female shape assembly step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.83.png" alt="Female shape assembly step 2" width="250">

6. Position the IGUS bearings on the TOP_trolley part.

<img src="https://braillerap.readthedocs.io/en/latest/_images/toptroley_assembly_empty_v3.png" alt="Top carriage bearing placement" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/toptroley_assembly_norizlan_v3.png" alt="Top carriage bearing positioning" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/toptroley_assembly_v3.png" alt="Top carriage cable ties installation" width="250">

8. Fit the M3-20 screws and the M3 nuts.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.86.png" alt="Top carriage belt screws step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.87.png" alt="Top carriage belt screws step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.51.1.jpg" alt="Installing linear shafts step 1" width="250">

2. Push the endstop and its support on the Ø8mm bar on the back side.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.51.2.jpg" alt="Installing endstop on shaft" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.51.3.jpg" alt="Installing bottom carriage on shafts" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.51.4.jpg" alt="Tightening axis holder screws" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.89.jpg" alt="Installing top carriage bars step 1" width="250">

2. Thread the top trolley over the rods.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.90.jpg" alt="Installing top carriage on bars" width="250">

3. Finish putting on the bars.

**Note:** The edge of the wood should remain visible.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.91.jpg" alt="Final bar positioning" width="250">

4. Tighten the axle holder screws on the body on the left and right.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.92.jpg" alt="Tightening top carriage holder screws" width="250">

5. Screw the grub screws of the axle supports on the left and right.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.93.jpg" alt="Tightening top carriage grub screws" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.40.jpg" alt="KP08 bearing alignment" width="250">

1. Screw the KP08_support and the KP08 on the body a bit with the M5-25 screws, M5 washers and M5 NYL nuts.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.34.1.jpg" alt="KP08 mounting" width="250">

2. Observe the position of the KP08 clamping rings.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.36.1.jpg" alt="KP08 clamping ring position 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.35.1.jpg" alt="KP08 clamping ring position 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.59.jpg" alt="Coupler installation" width="250">

2. Thread the 100mm linear shaft from the top through the KP08 and into the coupler.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.60.1.jpg" alt="Linear shaft installation" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.60.2.jpg" alt="Shaft rotation test" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.61.jpg" alt="Motor support screws" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.62.jpg" alt="Coupler bottom screws" width="250">

2. Thread the 100mm axle into the KP08, the pulleys (respecting their positions) and the coupler.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.63.jpg" alt="Final vertical axis assembly" width="250">

3. Screw the 2 screws at the top of the coupler onto the vertical axis.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.64.jpg" alt="Coupler top screws" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.65.jpg" alt="KP08 clamping ring screws" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.67.jpg" alt="Left KFL8 mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.68.jpg" alt="Left KFL8 mounting step 2" width="250">

2. Fix the KFL8 right on the body with the KFL8_support, 2 screws M5-18, 2 washers M5 and the 2 nuts M5 NYL.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.69.jpg" alt="Right KFL8 mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.70.jpg" alt="Right KFL8 mounting step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.73.jpg" alt="Y axis components installation" width="250">

5. Press the axle into the right KFL8 and cross it so that it protrudes ± 12mm from the body.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.74.jpg" alt="Y axis final positioning" width="250">

6. Tighten the screws of the KFL8 rings.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.75.jpg" alt="KFL8 ring tightening" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.76.jpg" alt="Y axis pulley alignment step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.76.1.jpg" alt="Y axis pulley alignment step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.77.jpg" alt="Y motor belt tensioning" width="250">

3. Tighten the 2 screws of the pulley of the axle.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.78.jpg" alt="Y axis pulley screws" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/paper_guide_left.png" alt="BrailleRAP left paper guide" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/paper_guide_right.png" alt="BrailleRAP right paper guide" width="250">

BrailleRAP XL use parts paper_guide_left_XL and paper_guide_right_XL.

<img src="https://braillerap.readthedocs.io/en/latest/_images/paper_guide_left_A3_v8.png" alt="BrailleRAP XL left paper guide" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/paper_guide_right_A3_v8.png" alt="BrailleRAP XL right paper guide" width="250">

1. Assemble the paper guides on the plate with the M3-16 screws and M3 NYL nuts.

<img src="https://braillerap.readthedocs.io/en/latest/_images/paper_support_assembly_screw_v2.png" alt="Paper guide screw assembly" width="250">

<img src="https://braillerap.readthedocs.io/en/latest/_images/paper_support_assembly_v1.png" alt="Left paper guide assembly" width="250">

2. Repeat the operation for the right side.

<img src="https://braillerap.readthedocs.io/en/latest/_images/paper_support_assembly_right_v1.png" alt="Right paper guide assembly" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/paper_support_assembly_papertest_v2.png" alt="Paper support test" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.96.jpg" alt="Paper plate bonding step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.97.jpg" alt="Paper plate bonding step 2" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.98.jpg" alt="Paper plate bonding step 3" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.104.jpg" alt="Clipboard mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.105.jpg" alt="Clipboard mounting step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/endstop_coude.jpg" alt="Angled endstop preferred" width="250">

1. Tap the adjustment screw support with an M3 tap

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.106.png" alt="Y endstop tapping" width="250">

2. Position the lever **ENDSTOP_Y_LEVER** in the support **ENDSTOP_Y_support**.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.106.1.png" alt="Y endstop lever positioning" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.106.2.png" alt="Y endstop lever mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.106.3.png" alt="Y endstop lever mounting step 2" width="250">

4. Assemble the limit switch and the **ENDSTOP_Y_support** using M2.5-14 screws and M2.5 NYL nuts.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.106.4.png" alt="Y endstop switch mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.106.5.png" alt="Y endstop switch mounting step 2" width="250">

5. Position the M3-12 adjustment screw on the lever **ENDSTOP_Y_LEVER_weight**

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.106.6.png" alt="Y endstop weight adjustment screw" width="250">

6. Add an M3-NYL nut , 2 M3 nuts and an M3-12 screw on the lever **ENDSTOP_Y_LEVER_weight**

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.106.7.png" alt="Y endstop weight assembly" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.107.jpg" alt="Y endstop final mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.108.jpg" alt="Y endstop final mounting step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.66.1.jpg" alt="Bottom carriage belt attachment step 1" width="250">

2. Pass the belt in the free pulley then the pulley of the vertical axis.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.66.2.jpg" alt="Bottom carriage belt routing" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/pulley_tensioner_down.jpg" alt="Bottom belt tensioning" width="250">

**Note:** For now, do not tighten the pulley bolts on the axle.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.66.jpg" alt="Bottom carriage belt final" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.66.1.jpg" alt="Top carriage belt attachment step 1" width="250">

2. Pass the belt in the free pulley then the pulley of the vertical axis.

<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V6.66.2.jpg" alt="Top carriage belt routing" width="250">

3. Tension the belt by holding the carriage and fix the second end of the belt to its screw with a cable tie.

4. Finish tensioning the belt using the screw on the outside of the body.

<img src="https://braillerap.readthedocs.io/en/latest/_images/pulley_tensioner_up.jpg" alt="Top belt tensioning" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.110.jpg" alt="Lid clips mounting step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.111.jpg" alt="Lid clips mounting step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/alim.jpg" alt="Power supply base plate" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/cablagemoteur.jpg" alt="Motor wiring diagram" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/braillerap_cablage.png" alt="MKS 1.4 general wiring diagram" width="350">

**Photo of the assembled board:**

<img src="https://braillerap.readthedocs.io/en/latest/_images/braillerap_carte.jpg" alt="MKS 1.4 assembled board" width="350">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/brap_cavalier.png" alt="MKS 1.4 jumper placement" width="250">

2. Push the drivers into X and Y slots.

<img src="https://braillerap.readthedocs.io/en/latest/_images/brap_drivers.png" alt="MKS 1.4 driver installation" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/board_12v.jpg" alt="MKS 1.4 12V power wiring" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/mks_driver_voltage.jpg" alt="Driver voltage measurement setup" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/mks_driver_voltage1.jpg" alt="MKS 1.4 driver voltage measurement step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/mks_driver_voltage2.jpg" alt="MKS 1.4 driver voltage measurement step 2" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/mks_driver_voltage3.jpg" alt="Driver voltage measurement step 3" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/board_endstop.jpg" alt="MKS 1.4 endstop wiring" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/brap_motorx.jpg" alt="MKS 1.4 X motor connection" width="250">

3. The Y motor (paper) must be plugged into the right connector (blue)

<img src="https://braillerap.readthedocs.io/en/latest/_images/brap_motory.jpg" alt="MKS 1.4 Y motor connection" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/board_magnet.jpg" alt="MKS 1.4 electromagnet wiring" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/mksgenl_schema.png" alt="MKS GEN-L V2.1 general wiring diagram" width="350">

**Photo of the assembled board:**

<img src="https://braillerap.readthedocs.io/en/latest/_images/mksgenl.jpg" alt="MKS GEN-L V2.1 assembled board" width="350">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/mksgenl_jumper.jpg" alt="MKS GEN-L jumper placement" width="250">

2. Push the drivers into X and Y slots.

<img src="https://braillerap.readthedocs.io/en/latest/_images/mksgenl_drivers.jpg" alt="MKS GEN-L driver installation" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/mksgenl_12V.jpg" alt="MKS GEN-L 12V power wiring" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/mks_driver_voltage.jpg" alt="MKS GEN-L driver voltage measurement setup" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/mks_driver_voltage1.jpg" alt="MKS GEN-L driver voltage measurement step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/mks_driver_voltage2.jpg" alt="MKS GEN-L driver voltage measurement step 2" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/mks_driver_voltage3.jpg" alt="MKS GEN-L driver voltage measurement step 3" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/mksgenl_endstops.jpg" alt="MKS GEN-L endstop wiring" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/mksgenl_motorx.jpg" alt="MKS GEN-L X motor connection" width="250">

3. The Y motor (paper) must be plugged into the right connector (blue)

<img src="https://braillerap.readthedocs.io/en/latest/_images/mksgenl_motory.jpg" alt="MKS GEN-L Y motor connection" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/mksgenl_solenoid.jpg" alt="MKS GEN-L electromagnet wiring" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/toppulley_fix.jpg" alt="Top carriage pulley loosening" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/female_fix1.jpg" alt="Female shape alignment step 1" width="250">
<img src="https://braillerap.readthedocs.io/en/latest/_images/female_fix2.jpg" alt="Female shape alignment step 2" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/toppulley_fix.jpg" alt="Top carriage vertical alignment preparation" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/magnet_align.jpg" alt="Carriage vertical alignment" width="250">

5. When the alignment is satisfactory, lock the upper pulley onto the vertical axis.

<img src="https://braillerap.readthedocs.io/en/latest/_images/toppulley_fix.jpg" alt="Final pulley tightening" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/endstopy_adjust.jpg" alt="Y endstop adjustment" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/BrailleRAP-V5.112.jpg" alt="Braille point depth adjustment" width="250">
...
<img src="https://braillerap.readthedocs.io/en/latest/_images/DOORLOCK_tap.png" alt="Door locker tapping" width="250">

2. Fix **DOORLOCKER** parts on the rear panel. Do not overtighten, **DOORLOCKER** part must move easily.

<img src="https://braillerap.readthedocs.io/en/latest/_images/door_locker.png" alt="Door locker installation" width="250">
